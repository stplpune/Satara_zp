...
const routes: Routes = [
  ...
  { path: 'dashbaord2', loadChildren: () => import('../../modules/dashbaord2/dashbaord2.module').then(m => m.Dashbaord2Module),canActivate: [ExpenseGuard], data: { breadcrumb: [{ title: 'Dashboard-2', m_title: 'डॅशबोर्ड-2', active: true }] }  },
