...
export class TasksheetReportsComponent {
  ...
  displayedheadersMarathi = ['अनुक्रमांक', 'शिक्षक कोड', 'शिक्षकाचे नाव', 'मोबाईल क्र', 'उपस्थित दिवस', 'अनुपस्थित दिवस','एकूण सुट्टी','आठवडा सुट्टी','मॅन्युअल उपस्थिती','सादर केलेली उपस्थिती','मॅन्युअल उपस्थिती मंजूर', 'कृती'];
